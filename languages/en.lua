...
STRINGS.NAMES.SPICEPACK_CHILI = string.gsub(STRINGS.NAMES.SPICE_CHILI_FOOD, "{food}", STRINGS.NAMES.SPICEPACK)
STRINGS.NAMES.SPICEPACK_SALT = string.gsub(STRINGS.NAMES.SPICE_SALT_FOOD, "{food}", STRINGS.NAMES.SPICEPACK)
STRINGS.NAMES.SPICEPACK_GARLIC = string.gsub(STRINGS.NAMES.SPICE_GARLIC_FOOD, "{food}", STRINGS.NAMES.SPICEPACK)
STRINGS.NAMES.SPICEPACK_SUGAR = string.gsub(STRINGS.NAMES.SPICE_SUGAR_FOOD, "{food}", STRINGS.NAMES.SPICEPACK)
...
STRINGS.CHARACTERS.WARLY.DESCRIBE.SPICEPACK_CHILI = "Not just burning food!"
STRINGS.CHARACTERS.WARLY.DESCRIBE.SPICEPACK_SALT = "Heavy salt cures impatience."
STRINGS.CHARACTERS.WARLY.DESCRIBE.SPICEPACK_GARLIC = "Garlic protector!"
STRINGS.CHARACTERS.WARLY.DESCRIBE.SPICEPACK_SUGAR = "Sugar light gone if unheld!"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPICEPACK_CHILI = "Spice that burns through pots."
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPICEPACK_SALT = "Slow-cook essence—no rushing."
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPICEPACK_GARLIC = "Hard garlic against thieves."
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SPICEPACK_SUGAR = "Sweet spice as swift as wind."
...
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DECOR_FOOD = "Go give a like to Warly the Value Monster mod!"
STRINGS.CHARACTERS.WARLY.DESCRIBE.IMPROV_COOKING_POWER = "Cooking power improved!"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.IMPROV_COOKING_POWER = "Enhances cooking ability."
...
STRINGS.CHARACTERS.WARLY.ANNOUNCE_SEARCH_FLAVOR_READY = "I smell the delicious aroma again!"
...
STRINGS.CHARACTERS.WARLY.ACTIONFAIL.CASTAOE.NOT_ENOUGH_COOKING_POWER = "I need more cooking power."

STRINGS.ACTIONS.SPOILED_ON_SACK = "Active Spoiled Cloud"
...
STRINGS.IMPROV_COOKING_POWER =
{
    ...
    HEALTH_PREFER = "Prefer Health (2 cost)",
    SANITY_PREFER = "Prefer Sanity (2 cost)",
    RAMDOM = "Random (1 cost)",
}
STRINGS.ACTIONS.USESPELLBOOK.IMPROV = "Improvise Play"
STRINGS.ACTIONS.CLOSESPELLBOOK.IMPROV = "Terminate"